...
serve(async (req: Request) => {
  ...
  try {
    ...
    const customerEmailContent = `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;"><div style="text-align: center; margin-bottom: 30px;"><h1 style="color: #4a5d23; margin: 0;">Za'atarati</h1><p style="color: #8B7355; margin: 5px 0;">Lebanese Mix</p></div><div style="background-color: #4a5d23; color: white; padding: 20px; border-radius: 8px; text-align: center; margin-bottom: 20px;"><h2 style="margin: 0;">Vielen Dank für Ihre Bestellung!</h2><p style="margin: 10px 0 0 0; font-size: 18px;"><strong>Bestellnummer: ${orderNumber}</strong></p></div><p style="color: #333; font-size: 16px;">Liebe/r ${orderDetails.customerName},</p><p style="color: #333; font-size: 16px;">herzlichen Dank, dass Sie sich für Za'atarati entschieden haben! Wir freuen uns sehr über Ihr Vertrauen und Ihre Bestellung. Ihre Zahlung wurde erfolgreich verarbeitet und wir bereiten Ihre Bestellung mit großer Sorgfalt vor.</p><div style="background-color: #f9f5f0; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #4a5d23;"><h3 style="color: #333; margin-top: 0;">Ihre Bestellübersicht</h3><p><strong>Bestellnummer:</strong> ${orderNumber}</p><p><strong>Produkt:</strong> ${orderDetails.productName}</p><p><strong>Menge:</strong> ${orderDetails.quantity}x</p><p><strong>Status:</strong> <span style="color: #22c55e; font-weight: bold;">Bezahlt</span></p>${orderDetails.shippingAddress ? `<p><strong>Lieferadresse:</strong> ${orderDetails.shippingAddress}</p>` : ""}</div><p style="color: #333; font-size: 16px;"><strong>Lieferzeit:</strong> 2-4 Werktage</p><p style="color: #333; font-size: 16px;">Bei Fragen stehen wir Ihnen gerne zur Verfügung: <a href="mailto:zaataratilibanon@gmail.com" style="color: #4a5d23;">zaataratilibanon@gmail.com</a></p><p style="color: #333; font-size: 16px;">Wir wünschen Ihnen viel Freude mit unseren authentischen libanesischen Gewürzen!</p><p style="color: #333; font-size: 16px;">Herzliche Grüße,<br><strong>Ihr Za'atarati Team</strong></p><div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e5e5;"><p style="color: #888; font-size: 12px;">Za'atarati - Authentische libanesische Gewürze</p></div></div>`;

    const ownerEmailContent = `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;"><div style="background-color: #22c55e; color: white; padding: 20px; border-radius: 8px; text-align: center; margin-bottom: 20px;"><h1 style="margin: 0;">NEUE BESTELLUNG - BEZAHLT!</h1><p style="margin: 10px 0 0 0; font-size: 20px;"><strong>Bestellnummer: ${orderNumber}</strong></p></div><h2>Bestelldetails</h2><p><strong>Bestellnummer:</strong> ${orderNumber}</p><p><strong>Produkt:</strong> ${orderDetails.productName}</p><p><strong>Menge:</strong> ${orderDetails.quantity}x</p><p><strong>Status:</strong> BEZAHLT</p><h2>Kundeninformationen</h2><p><strong>Name:</strong> ${orderDetails.customerName}</p><p><strong>Email:</strong> <a href="mailto:${orderDetails.customerEmail}">${orderDetails.customerEmail}</a></p>${orderDetails.customerPhone ? `<p><strong>Telefon:</strong> ${orderDetails.customerPhone}</p>` : ""}${orderDetails.shippingAddress ? `<p><strong>Lieferadresse:</strong> ${orderDetails.shippingAddress}</p>` : ""}<p style="color: #e65100; font-weight: bold; margin-top: 20px;">Bitte bereiten Sie die Bestellung für den Versand vor.</p></div>`;
